...
1. Apply the knowledge, skills, attitudes and behaviours necessary to bring new venture ideas into action.
2. Formulate a viable business model for their new venture.
3. Appraise complimentary skills required to set up and run a business.
4. Develop a presentation to articulate the business' business model.
5. Analyse a target market for the new ventures' product/service offering.
...
- Osterwalder, A. and A. Pigneur. \emph{Business Model Generation}. CA, USA: John Wiley & Sons, 2010.
...
|-------------------|---------------------|-----------|--------------|------------|
| WD_BBUSI_B | Bachelor of Business (Honours) | 3 | 6 | Elective |
...
*Module Code: A04867 | Timetable Code: BUSI-0304*
