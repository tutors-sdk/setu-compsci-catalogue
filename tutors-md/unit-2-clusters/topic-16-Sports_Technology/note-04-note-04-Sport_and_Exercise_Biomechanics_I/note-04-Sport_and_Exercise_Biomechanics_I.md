...
|-----------|-------------|
| **Module Code** | A22541 |
| **Module Title** | Sport & Exercise Biomechanics I |
...
- Qualititative biomechanics (e.g. non numerical description of a movement based on direct observation by coaches and teachers).
- Quantitative biomechanics (e.g. numerical measures from data colected during a movement).
...
- Blazevich, A. \emph{Sports Biomechanics - The Basics: Optimising human performance.}. London: A&C Black, 2007.
...
|-------------------|---------------------|-----------|--------------|------------|
| WD_T0010_X | Bachelor of Science (Honours) in Nutrition and Exercise Science | 1 | 2 | Mandatory |
| WD_T0011_X | Bachelor of Science (Honours) in Health and Exercise Science | 1 | 2 | Mandatory |
| WD_T0012_X | Bachelor of Science (Honours) in Sport and Exercise Science | 1 | 2 | Mandatory |

---

*Module Code: A22541 | Timetable Code: SPRT-0401*
